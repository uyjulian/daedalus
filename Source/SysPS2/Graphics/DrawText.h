...
#ifndef SYSPS2_GRAPHICS_DRAWTEXT_H_
#define SYSPS2_GRAPHICS_DRAWTEXT_H_
...
#include "SysPS2/UI/UIAlignment.h"
...
class CDrawText
{
	public:
		...
		static s32		GetTextWidth( EFont font, const char * p_str, u32 length, float scale );
		...
		static s32		GetTextWidth( EFont font, const char * p_str, float scale )										{ return GetTextWidth( font, p_str, strlen( p_str ), scale ); }
...
#endif // SYSPS2_GRAPHICS_DRAWTEXT_H_
