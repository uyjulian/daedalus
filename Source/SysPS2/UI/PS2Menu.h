...
const s16 SCREEN_WIDTH = 640;
const s16 SCREEN_HEIGHT = 480;

// to do adjust values to suit multiple screens
const s16 MENU_TOP = 5;
const s16 TITLE_HEADER = 10;

const s16 BELOW_MENU_MIN = 98; // Rename this as it's confusing

const s16 LIST_TEXT_LEFT = 20;
const s16 LIST_TEXT_WIDTH = SCREEN_WIDTH - LIST_TEXT_LEFT;
const s16 LIST_TEXT_HEIGHT = 335;

const s16 PREVIEW_IMAGE_LEFT = SCREEN_WIDTH - 221; //205x142
const s16 PREVIEW_IMAGE_BOTTOM = SCREEN_HEIGHT / 2;
const s16 PREVIEW_IMAGE_RIGHT = SCREEN_WIDTH - 16;
...
const s16 DESCRIPTION_AREA_BOTTOM = SCREEN_HEIGHT - 30;
...
const char * const	LOGO_FILENAME = DAEDALUS_PS2_PATH( "Resources/logo.png" );
...
const char* const		gSaveStatesDirectory = DAEDALUS_PS2_PATH("SaveStates/");
...
const char * const		gPreviewDirectory = DAEDALUS_PS2_PATH( "Resources/Preview/" );
