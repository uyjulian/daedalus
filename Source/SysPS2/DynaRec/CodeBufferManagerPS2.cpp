...
extern void Ps2IcacheInvalidateRange(void* start, int size);
...
struct SCodeBuffer
{
	...
	void	Finalise()
	{
		Ps2IcacheInvalidateRange( mpBuffer, mBufferPtr );
		if (mpBuffer != nullptr)
		{
			delete [] mpBuffer;
			mpBuffer = nullptr;
...
class CCodeBufferManagerPS2 : public CCodeBufferManager
{
public:
	CCodeBufferManagerPS2()
	{
	}
...
{
	return new CCodeBufferManagerPS2;
}


//

bool	CCodeBufferManagerPS2::Initialise()
{
...
void	CCodeBufferManagerPS2::Reset()
{
...
void	CCodeBufferManagerPS2::Finalise()
{
...
CCodeGenerator * CCodeBufferManagerPS2::StartNewBlock()
{
	...
	return new CCodeGeneratorPS2( &mAssemblyBufferA, &mAssemblyBufferB );
}


//

u32 CCodeBufferManagerPS2::FinaliseCurrentBlock()
{
