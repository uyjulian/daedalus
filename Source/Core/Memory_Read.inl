...
static const void * ReadInvalid( u32 address )
{
	...
	u8* temp = (u8 *)gMemBuffers[MEM_UNUSED];
...
static const void * Read_8000_807F( u32 address )
{
	...
	return (u8 *)gMemBuffers[MEM_RD_RAM] + (address & 0x007FFFFF);
}
...
static const void * Read_83F0_83F0( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_RD_REG0] + (address & 0xFF);
}
 ...
 static const void * Read_8400_8400( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_SP_MEM] + (address & 0x1FFF);
}
...
static const void * Read_8404_8404( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_SP_REG] + (address & 0xFF);
}
...
static const void * Read_8408_8408( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_SP_PC_REG] + (address & 0xFF);
}
...
static const void * Read_8410_841F( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_DPC_REG] + (address & 0xFF);
}
...
static const void * Read_8430_843F( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_MI_REG] + (address & 0xFF);
}
...
static const void * Read_8440_844F( u32 address )
{
	...
	u8* temp = (u8 *)gMemBuffers[MEM_VI_REG] + offset;
...
static const void * Read_8450_845F( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_AI_REG] + (address & 0xFF);
}
...
static const void * Read_8460_846F( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_PI_REG] + (address & 0xFF);
}
...
static const void * Read_8470_847F( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_RI_REG] + (address & 0xFF);
}
...
static const void * Read_8480_848F( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_SI_REG] + (address & 0xFF);
}
...
static const void * Read_9FC0_9FCF( u32 address )
{
	...
	#endif
	return (u8 *)gMemBuffers[MEM_PIF_RAM] + pif_ram_offset;
}
